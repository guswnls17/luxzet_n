  ...
  function init() {
    ...
    myDiagram.nodeTemplate =
      $(go.Node, go.Panel.Auto,
        { isShadowed: true },
        $(go.Shape,
          { figure: "Rectangle",					// figure: "Rectangle",
            fill: "azure" 
		  },
...
for i = 0 to lngDataCnt - 1
	...
	if i = 0 then
		response.write "{ key: """ & arrData(0, i) & """, color: """ & color0 & """, boss:"""", name: """ & arrData(12, i) & """, grade: """ & grade & """, selfsales: """ & selfinfo & """, child: """ & arrData(6, i) &  """, agency: """ &arrData(9, i) & """ , pic: """ & arrData(10, i) & """ }"
	else
		response.write ", { key: """ & arrData(0, i) & """, color: """ & color0 & """, boss: """ & arrData(1, i) & """, name: """ & arrData(12, i) & """, grade: """ & grade & """, selfsales: """ & selfinfo & """, child: """ & arrData(6, i) &  """, agency: """ &arrData(9, i) & """, pic: """ & arrData(10, i) & """ }"
	end if
next
%>
	];
  ...
  function nextStep(parentdata) {
	...
	document.location = "treeview.asp?memno=" + memno + "&memno1="+memno1+"&organ=<%=organ%>&down=" + ((parentdata.boss == '') ? 'no' : 'yes') + "&step=<%=step%>";
  }
