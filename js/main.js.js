	...
	$(window).resize(function(){
		...
		if($(window).width() < 981){
			if($(window).height() > 700){
				$(".mainCon3 .careerDiv .leftD").css("height","140px");
				$(".mainCon3 .careerDiv").css("top","190px");
				$(".mainCon3 .careerDiv .rightD").css("top","150px");
		...
		if($(window).width() > 1230){
			...
			$(".mainCon2 .swiper-container").css("top","450px");
			...
			$(".mainCon1 .listDiv .list4").css({"left":"50%","top":"200px"});
			...
			if($(window).width() < $(window).height()){
				...
				$(".mainCon2 .swiper-container").css("top","30%");
			...
			if($(window).width() < $(window).height()){
				...
				$(".mainCon2 .swiper-container").css("top","230px");
				$(".mainCon3 .careerDiv .leftD").css("height","190px");
				$(".mainCon3 .careerDiv").css("top","190px");
				$(".mainCon3 .careerDiv .rightD").css("top","210px");
						...
						if(_isHasScroll && _isScrollStart){
							setTimeout(function(){
								if(curWheel == 1){
									...
									TweenMax.to($(".mainCon3"), .5, {'top' : '0', ease:Power3.easeOut});
						...
						if(_isHasScroll && _isScrollEnd){
							setTimeout(function(){
								if(curWheel == 0){
									...
									isWheelMove = true;
									TweenMax.to($(".mainCon3"), .5, {'top' : '-203', ease:Power3.easeOut});
					...
					if(curWheel2 > q){//올라올때
						if(curWheel2 == 4){
							if(q == 3){
								...
								isWheelMove = true;
								TweenMax.to($(".mainSection").eq(3), 1, {'top' : '100%', ease:Power2.easeInOut});
								$(".mainIndi li").eq(3).removeClass("on");
...
function mainVis(){
	...
	TweenMax.to($(".mainVisDiv .visArea .visual").eq(0).find(".txtDiv .txt3"), 1.7, {top:385, opacity:1, delay:1.3, ease:Power4.easeOut, onComplte:function(){
		isRollMove = false;
	}});
		...
		$(this).click(function(){
			if(mainVisNum != i){
				if(!isRollMove){
					...
					TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum).find(".txt1").find("img"), 0, {top:102, ease:Power4.easeOut});
					TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum).find(".txt2").find("img"), 0, {top:89, ease:Power4.easeOut});
					TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum).find(".txt3"), 0, {top:435, opacity:0, ease:Power4.easeOut});
					TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum), 1, {left:"0", ease:Power2.easeOut, onComplete:function(){
						...
						TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum).find(".txt3"), 1.7, {top:385, opacity:1, delay:0.8, ease:Power4.easeOut});
...
function mainCon1(){
	...
	TweenMax.to($(".mainCon1 .txt2"), 1, {top:263, opacity:1, delay:1.1, ease:Power3.easeOut});
...
function mainCon2(){
	TweenMax.to($(".mainCon2 .txt1"), 1, {top:181, opacity:1, delay:.8, ease:Power3.easeOut});
	TweenMax.to($(".mainCon2 .txt2"), 1, {top:263, opacity:1, delay:1.1, ease:Power3.easeOut});
	TweenMax.to($(".mainCon2 .swiper-container"), 1, {top:350, opacity:1, delay:1.3, ease:Power3.easeOut});
};
function mainCon2_start(){
	...
	TweenMax.to($(".mainCon2 .swiper-container"), 0, {top:450, opacity:0, ease:Power3.easeOut});
};
...
function mainCon4(){
	TweenMax.to($(".mainCon4 .txt1"), 1, {top:181, opacity:1, delay:.8, ease:Power3.easeOut});
	TweenMax.to($(".mainCon4 .txt2"), 1, {top:263, opacity:1, delay:1.1, ease:Power3.easeOut});
	TweenMax.to($(".mainCon4 .careerDiv"), 1, {top:320, opacity:1, delay:1.3, ease:Power3.easeOut})
};
function mainCon4_start(){
	...
	TweenMax.to($(".mainCon4 .careerDiv"), 0, {top:420, opacity:0, ease:Power3.easeOut})
};
...
function rollingEvent(){
	...
	TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum), 1, {left:"0", ease:Power2.easeOut, onComplete:function(){
		...
		TweenMax.to($(".mainVisDiv .visArea .visual").eq(mainVisNum).find(".txt3"), 1.7, {top:385, opacity:1, delay:1.3, ease:Power4.easeOut});
		TweenMax.to($(".mainVisDiv .visBtn a").eq(mainVisNum).find(".bar"), 2, {width:"100%", ease:Power0.easeOut});
	}});
}
