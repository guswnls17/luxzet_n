          ...
          <TBODY>
            <TR> 
              <TD style="PADDING-LEFT: 5px" width=200 height=40><IMG 
                ...
                HOME &gt; <font color="1B660C">고객센터</font> &gt; <FONT color=1B660C><strong>1:1 Q&A</strong></FONT></SPAN> 
              </TD>
              ...
              <TD align="center" vAlign=top background=../images/center_center_bg.gif 
                bgColor=#ffffff><TABLE cellSpacing=0 cellPadding=0 width=700 align=center 
                  ...
                  <TBODY>
					...
					<tr>
					<td><img src="/images/board/customer_tit05.jpg"></td>
					</tr>
                    <TR> 
                      <TD style="PADDING-TOP: 10px" align=left>
					<%	
					If request("mode") = "write" Then
						Server.Execute("./customer/board_write.asp")
					ElseIf request("mode") = "view" Then
						Server.Execute("./customer/board_view.asp")
					ElseIf request("mode") = "exec" Then
						
						Server.Execute("./customer/board_save.asp")
					Else
						Server.Execute("./customer/board_list.asp")
					End If
					%>
					  </TD>
                    </TR>
