...
function mem_search(mem_no, mem_nm, gubun)
{
	...
	var url = './recommender_re.asp?no=' + mem_no + '&nm=' + mem_nm;

	var popup = window.open('./recommender_re.asp?gubun='+gubun, '_blank', 'width=580,height=552,scrollbars=no,status=no,menubar=no');
      ...
      <div class="container-fluid" id = "popmain">
        <div class="card">
    		<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-lg"><%=language(lan,18)%></h6>
            </div>
          <div class="card-body">
            <div class="table">
              <table class="table" width="100%" cellspacing="0">
                ...
                <form name='frmMain' method='post' action='./order/ordersignup_proc_re_te.asp' onsubmit='return input_check();' target='hiddenprocess'>
...
<input type='hidden' name='exchange_time' id='exchange_time' value='<%=nowtime%>'>
					...
					<tr>
					<th class="br-g bb-g tdp"><%=language(lan,54)%></th>
					  <td class="payment tdp">
							<p>
								<div class="input-group">
								<input type="text" name='n_spon_nm' id='n_spon_nm' class="w-25 ps"  readonly />
                    ...
                    <tr>
                      ...
                      <td class="tdp"><div class="form-group mb-0 ml-4">
<%
...
<% end if %>
                    ...
                    <tr>
                      <th class="br-g bb-g tdp"><%=language(lan,69)%></th>
                      <td class="tdp"><div class="form-group mb-0 ml-4">
