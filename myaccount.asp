        ...
        <div class="card">
          ...
          <div class="row ml-4 mr-4">
            <div class="card-body col-lg-6 col-md-12">
              <form name="frmMain" method="post" action="./member/memberproc.asp" onsubmit="return input_check();" target='hiddenprocess'>
<input type='hidden' name='command'>
<input type='hidden' name='imgchk'>	
                <div class="form-group">
                  <label for="" class="control-label mb-1"><%=language(lan,38)%></label>
                  <div class="input-group">
				  <% If mem_card_num= "" Or isnull(mem_card_num) Then %>
                        <input name="n_id" id="n_id" value="<%=n_id%>" type="text" class="form-control" aria-required="true" aria-invalid="false">
						...
						<button type="button" onclick="saveId();" class="btn btn-info ml-1"><%=language(lan,57)%></button>
				<% Else %>
