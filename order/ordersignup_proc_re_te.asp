...
'	Verification   = TRIM(request("io_wallet"))
	...
	sql = "select mem_code from mmember where mem_code = '" & spon& "' "
		
	If f_sql_modify(db_conn, sql) < 0 Then
		jsMessageBox "There is no spon information.", "", "document"
	End If
...
'		compaddr = "testecpaddress"
		...
		& ")values(getdate() ,'" & compaddr & "', '" & ecpAmt & "','" & ecp_code & "','" & memno & "', '" &session("userid") & "', '0', '" & spon & "','" & idate & "','" & odate & "','" & order_no & "','" & ecp_kum & "', '" & n_amount & "') "
...
'		compaddr = "testlxzaddress"
		...
		& ")values(getdate() ,'" & compaddr & "', '" & lxzAmt & "','" & lxz_code & "','" & memno & "', '" &session("userid") & "', '0', '" & spon & "','" & idate & "','" & odate & "','" & order_no & "','" & lxz_kum & "', '" & n_amount & "') "
