...
<!-- Begin Page Content -->
      ...
      <div class="card">
      	<div class="card-header py-3">
              <h6 class="m-0 font-weight-bold text-lg"><%=language(lan,32)%></h6>
            </div>
            ...
            <div class="form-group">
              <div class="input-group">
                ...
                <div class="input-group col-md-4 mt-2">
                    ...
                    <input type="text" name='n_memname' id='i_memname' class="form-control" readonly>
                    <div class="input-group-btn"><a onclick='window.open("./organize/membersearch.asp?no=frmMain.n_memno&nm=frmMain.n_memname&organ=spon", "", "width=520,height=455,scrollbars=no,status=no,menubar=no");' class="btn btn-primary"><i class="fa fa-search"></i> <%=language(lan,112)%></a></div>
                </div>
<!--                <div class="input-group col-md-4 mt-2">
                	 <label for="" class="pt-2 mr-2"><%=language(lan,111)%></label>
                    <select class="form-control col-md-2" id="step">
                    <%
									For i = 2 To 50
