...
<%
	...
	if idx<>"" and not isnull(idx) Then
		...
		Set rs = Server.createObject("ADODB.RecordSet")
		sql = "select (max(idx)+1) idx from dbo.boardq "
		rs.Open sql, Conn, 1
		idx		=	rs("idx") 
		rs.close
		DbClose()
     	...
     	<colgroup>
          ...
          <tr>
            ...
            <tr>
              ...
              <td>
				...
				<%if filename<>"" and  not isnull(filename) then%>
					<br><a href="/_uploadq/<%=filename%>" class="community_bar_unlink_text">&nbsp;<%=filename%></a>&nbsp;&nbsp;
            ...
            <tr>
              <td colspan="2">
                   <div class="sbmit-btn">
					  <div class="col-md-6 fl-l">
						<button type="submit" class="subform btn-mod btn-lg btn-block" onclick="submitContents(form);">Confirm</button>
					  </div> 
					  <div class="col-md-6 fl-l">
						<button type="button" class="subform btn-mod btn-lg btn-block popup" onclick="history.go(-1);">Cancellation</button>
					  </div>
